...
function Auth({ redirectAfterAuth }: AuthProps = {}) {
  ...
  const handleOtpSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError("O código de verificação que introduziu está incorreto.");
      setIsLoading(false);
            ...
            {step === "signIn" ? (
              <>
                <CardHeader className="text-center">
                  ...
                  <CardDescription>
                    Introduza o seu email para entrar ou criar conta
                  </CardDescription>
                </CardHeader>
              ...
              <>
                <CardHeader className="text-center mt-4">
                  <CardTitle>Verifique o seu email</CardTitle>
                  <CardDescription>
                    Enviámos um código para {step.email}
                  </CardDescription>
                </CardHeader>
