...
import {
  Primitive
} from "./chunk-YDBXID3N.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-ZDTTIQV2.js";
import "./chunk-5ZBUJB2O.js";
import {
  require_jsx_runtime
...
var AccordionImplSingle = React10.forwardRef(
  (props, forwardedRef) => {
    const {
      value: valueProp,
      defaultValue,
    ...
    return (0, import_jsx_runtime6.jsx)(
      AccordionValueProvider,
      {
        ...
        value: React10.useMemo(() => value ? [value] : [], [value]),
        onItemOpen: setValue,
        onItemClose: React10.useCallback(() => collapsible && setValue(""), [collapsible, setValue]),
...
var AccordionImplMultiple = React10.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleItemOpen = React10.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleItemClose = React10.useCallback(
...
var AccordionImpl = React10.forwardRef(
  (props, forwardedRef) => {
    const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
    const accordionRef = React10.useRef(null);
