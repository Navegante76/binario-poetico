import {
  ...
  queryGeneric
} from "./chunk-C5SOSVMS.js";
import {
  require_dist
} from "./chunk-KBQMSZJ5.js";
import {
  ConvexError,
  v
} from "./chunk-WA7TFFCC.js";
import {
  bigEndian,
  generateRandomString,
  rotr32
} from "./chunk-DZWLKFT4.js";
import {
  __export,
  __toESM
...
_SessionStore_chunks = /* @__PURE__ */ new WeakMap(), _SessionStore_option = /* @__PURE__ */ new WeakMap(), _SessionStore_logger = /* @__PURE__ */ new WeakMap(), _SessionStore_instances = /* @__PURE__ */ new WeakSet(), _SessionStore_chunk = function _SessionStore_chunk2(cookie) {
  ...
  for (let i2 = 0; i2 < chunkCount; i2++) {
    ...
    const value = cookie.value.substr(i2 * CHUNK_SIZE, CHUNK_SIZE);
...
var encodeBase64 = (input) => {
  ...
  const arr = [];
  for (let i2 = 0; i2 < unencoded.length; i2 += CHUNK_SIZE2) {
    arr.push(String.fromCharCode.apply(null, unencoded.subarray(i2, i2 + CHUNK_SIZE2)));
  }
...
function P(n2, l2, u3, t2, i2, o2, r2, f2, e2, c2, s2) {
  var a2, p2, y2, d2, w2, _2 = t2 && t2.__k || v2, g2 = l2.length;
  for (u3.__d = e2, $(u3, l2, _2), e2 = u3.__d, a2 = 0; a2 < g2; a2++) null != (y2 = u3.__k[a2]) && (p2 = -1 === y2.__i ? h : _2[y2.__i] || h, y2.__i = a2, O(n2, y2, p2, i2, o2, r2, f2, e2, c2, s2), d2 = y2.__e, y2.ref && p2.ref != y2.ref && (p2.ref && N(p2.ref, null, y2), s2.push(y2.ref, y2.__c || d2, y2)), null == w2 && null != d2 && (w2 = d2), 65536 & y2.__u || p2.__k === y2.__k ? e2 = I(y2, e2, n2) : "function" == typeof y2.type && void 0 !== y2.__d ? e2 = y2.__d : d2 && (e2 = d2.nextSibling), y2.__d = void 0, y2.__u &= -196609);
  u3.__d = e2, u3.__e = w2;
}
function $(n2, l2, u3) {
  var t2, i2, o2, r2, f2, e2 = l2.length, c2 = u3.length, s2 = c2, a2 = 0;
  for (n2.__k = [], t2 = 0; t2 < e2; t2++) null != (i2 = l2[t2]) && "boolean" != typeof i2 && "function" != typeof i2 ? (r2 = t2 + a2, (i2 = n2.__k[t2] = "string" == typeof i2 || "number" == typeof i2 || "bigint" == typeof i2 || i2.constructor == String ? g(null, i2, null, null, null) : y(i2) ? g(b, { children: i2 }, null, null, null) : void 0 === i2.constructor && i2.__b > 0 ? g(i2.type, i2.props, i2.key, i2.ref ? i2.ref : null, i2.__v) : i2).__ = n2, i2.__b = n2.__b + 1, o2 = null, -1 !== (f2 = i2.__i = L(i2, u3, r2, s2)) && (s2--, (o2 = u3[f2]) && (o2.__u |= 131072)), null == o2 || null === o2.__v ? (-1 == f2 && a2--, "function" != typeof i2.type && (i2.__u |= 65536)) : f2 !== r2 && (f2 == r2 - 1 ? a2-- : f2 == r2 + 1 ? a2++ : (f2 > r2 ? a2-- : a2++, i2.__u |= 65536))) : i2 = n2.__k[t2] = null;
  if (s2) for (t2 = 0; t2 < c2; t2++) null != (o2 = u3[t2]) && 0 == (131072 & o2.__u) && (o2.__e == n2.__d && (n2.__d = x(o2)), V(o2, o2));
}
function I(n2, l2, u3) {
  var t2, i2;
  if ("function" == typeof n2.type) {
    for (t2 = n2.__k, i2 = 0; t2 && i2 < t2.length; i2++) t2[i2] && (t2[i2].__ = n2, l2 = I(t2[i2], l2, u3));
    return l2;
  }
...
function L(n2, l2, u3, t2) {
  var i2 = n2.key, o2 = n2.type, r2 = u3 - 1, f2 = u3 + 1, e2 = l2[u3];
  if (null === e2 || e2 && i2 == e2.key && o2 === e2.type && 0 == (131072 & e2.__u)) return u3;
...
function O(n2, u3, t2, i2, o2, r2, f2, e2, c2, s2) {
  ...
  n: if ("function" == typeof T2) try {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i2 = d(d({}, i2), h2.getChildContext())), x2 && !v4 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(p2, w2)), P(n2, y(L2 = null != a2 && a2.type === b && null == a2.key ? a2.props.children : a2) ? L2 : [L2], u3, t2, i2, o2, r2, f2, e2, c2, s2), h2.base = u3.__e, u3.__u &= -161, h2.__h.length && f2.push(h2), g2 && (h2.__E = h2.__ = null);
  } catch (n3) {
  ...
  else null == r2 && u3.__v === t2.__v ? (u3.__k = t2.__k, u3.__e = t2.__e) : u3.__e = z(t2.__e, u3, t2, i2, o2, r2, f2, c2, s2);
  (a2 = l.diffed) && a2(u3);
}
function j(n2, u3, t2) {
  u3.__d = void 0;
...
function z(u3, t2, i2, o2, r2, f2, e2, c2, s2) {
  var a2, v4, p2, d2, _2, g2, m2, b2 = i2.props, k2 = t2.props, C2 = t2.type;
  ...
  if (null === C2) b2 === k2 || c2 && u3.data === k2 || (u3.data = k2);
    ...
    if (f2 = f2 && n.call(u3.childNodes), b2 = i2.props || h, !c2 && null != f2) for (b2 = {}, a2 = 0; a2 < u3.attributes.length; a2++) b2[(_2 = u3.attributes[a2]).name] = _2.value;
    ...
    else if (p2 && (u3.innerHTML = ""), P(u3, y(d2) ? d2 : [d2], t2, i2, o2, "foreignObject" === C2 ? "http://www.w3.org/1999/xhtml" : r2, f2, e2, f2 ? f2[0] : i2.__k && x(i2, 0), c2, s2), null != f2) for (a2 = f2.length; a2--; ) w(f2[a2]);
...
function V(n2, u3, t2) {
  var i2, o2;
  if (l.unmount && l.unmount(n2), (i2 = n2.ref) && (i2.current && i2.current !== n2.__e || N(i2, null, u3)), null != (i2 = n2.__c)) {
  ...
  if (i2 = n2.__k) for (o2 = 0; o2 < i2.length; o2++) i2[o2] && V(i2[o2], u3, t2 || "function" != typeof n2.type);
...
if (Uint8Array.prototype.toBase64) {
  ...
  encodeBase64Url = (input) => {
    ...
    const arr = [];
    for (let i2 = 0; i2 < input.byteLength; i2 += CHUNK_SIZE2) {
      arr.push(String.fromCharCode.apply(null, input.subarray(i2, i2 + CHUNK_SIZE2)));
    }
...
function normalizeOAuth(c2) {
  if (c2.issuer)
    c2.wellKnown ??= `${c2.issuer}/.well-known/openid-configuration`;
...
function normalizeEndpoint(e2, issuer) {
  ...
  const url = new URL(e2?.url ?? PLACEHOLDER_URL);
  if (e2?.params != null) {
...
var SHA256 = class {
  ...
  process() {
    ...
    for (let t2 = 0; t2 < 64; t2++) {
      ...
      const ch = (e2 & f2 ^ ~e2 & g2) >>> 0;
      const t1 = h2 + sigma1 + ch + K2[t2] + this.w[t2] | 0;
...
function generateRandomString2(length, alphabet) {
  const random = {
    read(bytes) {
...
async function userOAuthImpl(ctx, args, getProviderOrThrow, config) {
  ...
  const code = generateRandomString2(8, "0123456789");
...
async function handleEmailAndPhoneProvider(ctx, provider, args, options) {
  ...
  const code = provider.generateVerificationToken ? await provider.generateVerificationToken() : generateRandomString2(32, alphabet);
...
//# sourceMappingURL=chunk-WLI7PWPZ.js.map
